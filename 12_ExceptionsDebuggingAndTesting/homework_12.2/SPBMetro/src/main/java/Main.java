...
public class Main {
    ...
    private static final String DATA_FILE = "C:/Users/AVK/Documents/Java/java_basics/12_ExceptionsDebuggingAndTesting/homework_12.2/SPBMetro/src/main/resources/map.json";
    ...
    public static void main(String[] args) {
        ...
        loggerExceptions = LogManager.getRootLogger();
        loggerSearch = LogManager.getLogger("search");
        loggerInputErrors = LogManager.getLogger("input_errors");
        ...
        for (; ; ) {
            try {
                ...
                loggerExceptions.debug(ex.getStackTrace());
            }
        }
    }
    ...
    private static Station takeStation(String message) {
        for (; ; ) {
            ...
            if (station != null) {
                loggerSearch.info("Станция найдена: " + line);
                return station;
            }
